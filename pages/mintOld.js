...
function Mint() {
  ...
  return (
    <div className="flex flex-col h-full w-full justify-center items-center font-coiny bg-black">

      <div className="absolute top-32 right-0 w-1/3 h-1/3 md:w-2/4 md:h-2/4 z-10" 
          style={{
      ...
      />
        ...
        <div className="relative my-auto md:top-8 top-2 py-10 px-6 flex-col justify-center rounded-lg xl:w-[55%] mx-4 w-[95%] bg-black bg-opacity-10 backdrop-blur-md rounded-lg p-4 shadow-md border border-white border-opacity-30">
