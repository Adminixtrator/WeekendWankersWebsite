  ...
  return (
    <section className="py-16 border-b border-gold/20 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="md:w-1/2 px-4">
        ...
        <p className="text-white/90 text-base">Everything being built fuels $LUCKY&apos;s value:</p>
        <ul className="list-disc pl-6 mt-4 space-y-2 text-white/90 text-lg">
        ...
        <p className="text-md text-white/60 italic mt-2">
