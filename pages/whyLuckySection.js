  ...
  return (
    <section className="py-16 border-b border-gold/20 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="md:w-1/2 px-4">
        <h2 className="text-2xl font-bold text-gold text-center md:text-left mb-8 font-coiny">Why This Supports $Wankers 🍀</h2>
        <p className="text-white/90 text-sm md:text-base">Everything being built fuels $Wankers&apos;s value:</p>
        <ul className="list-disc pl-6 mt-4 space-y-2 text-white/90 text-sm md:text-base">
          <li>Staking locks supply, increasing value</li>
          <li>The game creates demand & buy pressure for $Wankers</li>
